...
type
  TForm2 = class(TForm)
    ...
    procedure KeyCanvalClick(Sender: TObject);
  private
...
begin
  TimeLine.SetFocus;
  TimeLine.Position := TimeLine.Position - WheelDelta * 3;
end;

var
  Selected: Integer = 0;

procedure TForm2.KeyCanvalClick(Sender: TObject);
begin
  TimeLine.SetFocus;
end;
        ...
        begin
          ...
          if kType = 1 then
            ...
            begin
              ...
              DeleteSlide(KeyNum);
              DrawTime(TimeLine.Max - TimeLine.Position,
                TimeLine.Max - TimeLine.Position + 2500 div SpeedBar.Position);
              Break;
            end;
        end;
      end;
